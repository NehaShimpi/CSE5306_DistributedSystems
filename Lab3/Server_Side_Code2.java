...
/*This class is BackUp Server Code*/
...
public class Server_Side_Code2 {

	ArrayList<Client_Handler2> client_list = new ArrayList<Client_Handler2>();
	Timer pollTimer;

	public Server_Side_Code2() {
		try {
	...
	public static void main(String[] args) {
		Server_Side_Code2 s = new Server_Side_Code2();
		new Server_Side_GUI2();/*Server UI is loaded*/
		s.conversation(port);
	}
	...
	public void conversation(int port) {
		try {
			...
			Server_Side_GUI2.Conversations.setText("Listening");
			...
			while (true) {/*This part of code enables handling of multiple clients*/
				...
				Client_Handler2 myClient = new Client_Handler2(socket);
...
/*https://stackoverflow.com/questions/9413656/how-to-use-timer-class-to-call-a-method-do-something-reset-timer-repeat*/
	...
	BufferedReader br;
	static int port = Constants.BACKUP_PORT;/* Port on which communication will start*/
